...
createApp({
    setup() {
        const frasesOriginales = [
            ...
            { frase: 'No te preocupes si no funciona bien. Si todo estuviera bien, no estarías en el trabajo.', autor: 'Mosher’s Law of Software' }
        ];
        ...
        const editarFrase = (index) => {
            const frase = frases.value[index];
            nuevaFrase.value.frase = frase.frase;
            nuevaFrase.value.autor = frase.autor;
            frases.value.splice(index, 1);
        };
